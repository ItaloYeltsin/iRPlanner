...
public class PositioningIn extends Window {

	public PositioningIn(ReleasePlanningProblem rpp, Stage stage) {
		super(rpp, stage);
		stage.setTitle("Add New Positioning In");
		...
		controller.button.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				Preference pref = PreferenceFactory.makePreference(
						"positioning_in", "" + comb1.selectedIndex() + " "
