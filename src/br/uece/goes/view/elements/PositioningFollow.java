...
public class PositioningFollow extends Window{

	public PositioningFollow(ReleasePlanningProblem rpp, Stage stage) {
		super(rpp, stage);
		stage.setTitle("Add New Positioning Follow");
		...
		controller.button.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				Preference pref = 
						PreferenceFactory.makePreference("positioning_follow", 
