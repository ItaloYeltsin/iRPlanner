...
public class PositioningBefore extends Window {

	public PositioningBefore(ReleasePlanningProblem rpp, Stage stage) {
		super(rpp, stage);
		stage.setTitle("Add New Positioning Before");
		...
		controller.button.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				Preference pref = PreferenceFactory.makePreference(
						"positioning_before", "" + comb1.selectedIndex() + " "
